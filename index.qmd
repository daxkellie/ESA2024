...
ggplot(data = data,
  ...
  theme(
    ...
    plot.background = element_rect(fill = "#8B3D30", colour = "#8B3D30"),
    panel.background = element_rect(fill = "#8B3D30", colour = "#8B3D30"),
...
## Supporting reproducibility at the ALA {background-color="#FEEFEC"}
...
# 6 simple steps <br> [to make your R code run again]{style="font-size:60%;"} {background-color="#3E232E" style="color: #ffffff; font-size: 70%" transition="fade"}

## 1. Create an R Project {background-color="#F6F3F4"}
...
## 3. Organised folder structure {background-color="#F6F3F4"}
...
## 5. Record packages & versions {background-color="#F6F3F4"}
...
## Other useful resources {background-color="#1B2D28" style="color: #ffffff;"}
